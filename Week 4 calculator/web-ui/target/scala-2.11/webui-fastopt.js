...
$c_Lcalculator_Calculator$.prototype.eval__T__Lcalculator_Expr__sci_Map__D = (function(cell, expr, references) {
  if ($is_Lcalculator_Literal(expr)) {
    var x2 = $as_Lcalculator_Literal(expr);
    var v = x2.v$2;
    return v
  } else if ($is_Lcalculator_Plus(expr)) {
    var x3 = $as_Lcalculator_Plus(expr);
    var a = x3.a$2;
    var b = x3.b$2;
    return (this.eval__T__Lcalculator_Expr__sci_Map__D(cell, a, references) + this.eval__T__Lcalculator_Expr__sci_Map__D(cell, b, references))
  } else if ($is_Lcalculator_Minus(expr)) {
    var x4 = $as_Lcalculator_Minus(expr);
    var a$2 = x4.a$2;
    var b$2 = x4.b$2;
    return (this.eval__T__Lcalculator_Expr__sci_Map__D(cell, a$2, references) - this.eval__T__Lcalculator_Expr__sci_Map__D(cell, b$2, references))
  } else if ($is_Lcalculator_Times(expr)) {
    var x5 = $as_Lcalculator_Times(expr);
    var a$3 = x5.a$2;
    var b$3 = x5.b$2;
    return (this.eval__T__Lcalculator_Expr__sci_Map__D(cell, a$3, references) * this.eval__T__Lcalculator_Expr__sci_Map__D(cell, b$3, references))
  } else if ($is_Lcalculator_Divide(expr)) {
    var x6 = $as_Lcalculator_Divide(expr);
    var a$4 = x6.a$2;
    var b$4 = x6.b$2;
    return (this.eval__T__Lcalculator_Expr__sci_Map__D(cell, a$4, references) / this.eval__T__Lcalculator_Expr__sci_Map__D(cell, b$4, references))
  } else if ($is_Lcalculator_Ref(expr)) {
    var x7 = $as_Lcalculator_Ref(expr);
    var name = x7.name$2;
    if ((cell === name)) {
      return (NaN)
    } else {
      var expr$2 = references.get__O__s_Option(name);
      if (expr$2.isEmpty__Z()) {
        var this$1 = $m_s_None$()
      } else {
        var arg1 = expr$2.get__O();
        var sig = $as_Lcalculator_Signal(arg1);
        var this$1 = new $c_s_Some().init___O($m_Lcalculator_Calculator$().eval__T__Lcalculator_Expr__sci_Map__D(cell, $as_Lcalculator_Expr(sig.apply__O()), references))
      };
      return $uD((this$1.isEmpty__Z() ? (NaN) : this$1.get__O()))
    }
  } else {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      var deltaroot = $uD($g.Math.sqrt(a$1));
      var minusb = (-$uD(b$2.apply__O()));
      var twoa = (2 * $uD(a$2.apply__O()));
      var array = [((minusb + deltaroot) / twoa), ((minusb - deltaroot) / twoa)];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var ax = $uD(a$1.apply__O());
      var bx = $uD(b$1.apply__O());
      var cx = $uD(c$1.apply__O());
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var rem = $uI(remainingCharsCount$1.apply__O());
      return ((rem >= 15) ? "green" : (((rem >= 0) && (rem < 15)) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, name$1, sig$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__T__Lcalculator_Expr__sci_Map__D(name$1, $as_Lcalculator_Expr(sig$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, name, sig));
